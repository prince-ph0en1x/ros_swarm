...
public:
	...
	void runAlgo()
	{
		...
		cout << "\nHGR Solution Sequence (makespan + cost): " << soln_ilp << endl;
		for (a = 0; a < size; a++) {
			for (o = 0; o < size; o++) {
...
private:
	...
	int main(int argc, char** argv)
	{
		...
		ilp1_soln.close();
		cout << "\nILP Solution Sequence (makespan) : " << soln_ilp << endl;
		for (a = 0; a < u; a++) {
			for (o = 0; o < u; o++) {
		...
		// start HCK time
		for (mksp_hck = min; mksp_hck <= max; mksp_hck++) {	// upgrade to only skim through edges
			for (a = 0; a < u; a++) {
				for (o = 0; o < u; o++) {
					if (e[a][o] <= mksp_hck)
						hck.Adj[a][o] = 1;
		...
		ilp2_soln.close();
		cout << "\nILP Solution Sequence (makespan + cost): " << soln_ilp << endl;
		for (a = 0; a < u; a++) {
			for (o = 0; o < u; o++) {
				if (soln_ilp[a*u+o] == '1')	cout << e[a][o] << "\t";
				else						cout << ".\t";
